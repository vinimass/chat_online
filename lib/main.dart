...
void main() async {
  ...
  //Firestore.instance.collection("mensagens").document("msg1").setData({"from" : "Vinicius", "texto" : "Olá"});
  //Firestore.instance.collection("mensagens").document().setData({"from" : "Vinicius", "texto" : "Tudo bem?"});
  //Firestore.instance.collection("mensagens").document().setData({"from" : "Vinicius", "texto" : "Olá"});
